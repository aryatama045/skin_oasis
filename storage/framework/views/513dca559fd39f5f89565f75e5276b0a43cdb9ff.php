<div class="mobile-toolbar d-block d-md-none d-lg-none">
    <div class="d-table table-layout-fixed w-100">
        <a href="<?php echo e(route('home')); ?>" class="d-table-cell mobile-toolbar-item  mobile-menu-toggle">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            <span class="mobile-toolbar-label">
                <?php echo e(localize('Home')); ?>
        ...
        <div class="gshop-header-search dropdown d-table-cell mobile-toolbar-item">
            <button class="header-icon" type="button" data-bs-toggle="dropdown">
                ...
                <span class="mobile-toolbar-label"><?php echo e(localize('Search')); ?></span>
            </button>
            <div class="dropdown-menu dropdown-menu-start border-0">
                <form class="search-form d-flex align-items-center" action="<?php echo e(route('products.index')); ?>">
                    <input type="text" placeholder="<?php echo e(localize('Search products')); ?>..." class="w-100"
                        name="search" <?php if(isset($searchKey)): ?> value="<?php echo e($searchKey); ?>" <?php endif; ?>>
                    <button type="submit" class="submit-icon-btn-secondary"><i
                            class="fa-solid fa-magnifying-glass"></i></button>
                </form>
            </div>
        </div>
        <a class="d-table-cell mobile-toolbar-item" href="<?php echo e(route('customers.dashboard')); ?>">
            <span class="mobile-toolbar-icon">
            ...
            <span class="mobile-toolbar-label"><?php echo e(localize('Account')); ?></span>
        </a>
        <a class="d-table-cell mobile-toolbar-item" href="<?php echo e(route('carts.index')); ?>">
            ...
            <span class="mobile-toolbar-icon mobile-cart-icon">
                ...
                <small class="badge bg-primary cart-counter"><?php echo e(count($carts)); ?></small>
            </span>
            <span class="mobile-toolbar-label sub-total-price"><?php echo e(formatPrice(getSubTotal($carts, false))); ?></span>
        </a>
    </div>
</div>
