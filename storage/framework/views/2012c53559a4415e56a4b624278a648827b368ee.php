            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="widget widget-about">
                        <img src="<?php echo e(uploadedAsset(getSetting('footer_logo'))); ?>" class="footer-logo" alt="Footer Logo" width="200" height="25">
                        <p>
                    ...
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            <li>
                                <div class="row">
                                    <div class="col-2">
                                        <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/svg/lokasi.png')); ?>" style="width: 100px">
                                    </div>
                                    <div class="col-10">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-2">
                                        <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/svg/telpon.png')); ?>" style="width: 100px">
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-2">
                                        <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/svg/fax.png')); ?>" style="width: 100px">
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-2">
                                        <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/svg/mail.png')); ?>" style="width: 100px">
                                    </div>
