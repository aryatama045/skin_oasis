...
<head>
    ...
    <meta name="msapplication-config" content="<?php echo e(staticAsset('frontend/skinoasis/assets/images/icons/browserconfig.xml')); ?>">
    <meta name="theme-color" content="#ffffff">

    <!--favicon icon-->
    <link rel="icon" href="<?php echo e(uploadedAsset(getSetting('favicon'))); ?>" type="image/png" sizes="16x16">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(uploadedAsset(getSetting('favicon'))); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(uploadedAsset(getSetting('favicon'))); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(uploadedAsset(getSetting('favicon'))); ?>">
    ...
    <!-- head-scripts -->
    <?php echo $__env->make('frontend.skinoasis.inc.head-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- head-scripts -->

    <!--build:css-->
    <?php echo $__env->make('frontend.skinoasis.inc.css', ['localLang' => $localLang], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- endbuild -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <?php if(isset($exception)): ?>
            <?php if($exception->getStatusCode() != 503): ?>
                <?php echo $__env->make('frontend.skinoasis.inc.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        <?php else: ?>
            <?php echo $__env->make('frontend.skinoasis.inc.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <?php if(isset($exception)): ?>
            <?php if($exception->getStatusCode() != 503): ?>
                <?php echo $__env->make('frontend.skinoasis.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('frontend.skinoasis.inc.bottomToolbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        <?php else: ?>
            <?php echo $__env->make('frontend.skinoasis.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('frontend.skinoasis.inc.bottomToolbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <!-- modals -->
    <?php echo $__env->make('frontend.skinoasis.pages.partials.products.quickViewModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- modals -->
    ...
    <div class="mobile-menu-container">
        <?php echo $__env->make('frontend.skinoasis.inc.navMobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/images/popup/newsletter/logo.png')); ?>" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/images/popup/newsletter/img-1.jpg')); ?>" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--build:js-->
    <?php echo $__env->make('frontend.skinoasis.inc.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--endbuild-->
