<div class="account-nav bg-white rounded py-5">
    <h6 class="mb-4 px-4"><?php echo e(localize('Manage My Account')); ?></h6>
    <ul class="nav nav-tabs border-0 d-block account-nav-menu" role="tablist">
        <li>
            <a href="<?php echo e(route('customers.dashboard')); ?>" class="<?php echo e(areActiveRoutes(['customers.dashboard'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Dashboard')); ?>

            </a>
        </li>
        <li>
            <a href="<?php echo e(route('customers.orderHistory')); ?>"
                class="<?php echo e(areActiveRoutes(['customers.orderHistory'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Order History')); ?>
        ...
        <?php if(getSetting('enable_reward_points') == 1): ?>
            <li>
                <a href="<?php echo e(route('customers.rewardPoints')); ?>"
                    class="<?php echo e(areActiveRoutes(['customers.rewardPoints'], 'active')); ?>">
                    <span class="me-2">
                    ...
                    <?php echo e(localize('Reward Points')); ?>
        ...
        <li>
            <a href="<?php echo e(route('customers.walletHistory')); ?>"
                class="<?php echo e(areActiveRoutes(['customers.walletHistory'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Wallet History')); ?>
        ...
        <?php if(getSetting('enable_refund_system') == 1): ?>
            <li>
                <a href="<?php echo e(route('customers.refunds')); ?>"
                    class="<?php echo e(areActiveRoutes(['customers.refunds'], 'active')); ?>">
                    <span class="me-2">
                    ...
                    <?php echo e(localize('Refund History')); ?>

                </a>
            </li>
        <?php endif; ?>
        <li>
            <a href="<?php echo e(route('customers.trackOrder')); ?>"
                class="<?php echo e(areActiveRoutes(['customers.trackOrder'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Track Order')); ?>

            </a>
        </li>

        <li>
            <a href="<?php echo e(route('customers.address')); ?>"
                class="<?php echo e(areActiveRoutes(['customers.address'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Address Book')); ?>
        ...
        <li>
            <a href="<?php echo e(route('customers.profile')); ?>"
                class="<?php echo e(areActiveRoutes(['customers.profile'], 'active')); ?>">
                <span class="me-2">
                ...
                <?php echo e(localize('Updated Profile')); ?>
        ...
        <li>
            <a href="<?php echo e(route('logout')); ?>">
                ...
                <?php echo e(localize('Log out')); ?>

            </a>
        </li>
    </ul>
</div>
<?php /**PATH C:\xampp\htdocs\skin_oasis\resources\views/frontend/skinoasis/pages/users/partials/customerSidebar.blade.php ENDPATH**/ ?>