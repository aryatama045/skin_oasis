        ...
        <div class="row">
                    ...
                    <div class="p-4 ">
                        ...
                        <div class="tab-content" id="tab-content-6">
                            <div class="tab-pane fade active show" id="tab-21" role="tabpanel" aria-labelledby="tab-21-tab">
                                <!-- Article -->
                                <?php echo $__env->make('frontend.skinoasis.pages.users.content.articleList', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="tab-pane fade" id="tab-22" role="tabpanel" aria-labelledby="tab-22-tab">
                                <!-- Video -->
                                <?php echo $__env->make('frontend.skinoasis.pages.users.content.feedVideo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="tab-pane fade" id="tab-23" role="tabpanel" aria-labelledby="tab-23-tab">
                                <!-- Review -->
                                <?php echo $__env->make('frontend.skinoasis.pages.users.content.reviewList', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="tab-pane fade" id="tab-24" role="tabpanel" aria-labelledby="tab-24-tab">
                                <!-- Photo -->
                                <?php echo $__env->make('frontend.skinoasis.pages.users.content.feedPhoto', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
            ...
            <div class="col-lg-4" >
                <div class="icondiv rounded shadow-box bg-white ">
                    <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/images/icons/icon-send.JPG')); ?>" alt="icon" class="icon-img">
                ...
                <div class="icondiv rounded shadow-box bg-white mt-5">
                    <img src="<?php echo e(staticAsset('frontend/skinoasis/assets/images/icons/icon-form.JPG')); ?>" alt="icon" class="icon-img">
                    <div class="icon-content">
...
<?php echo $__env->make('frontend.skinoasis.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skin_oasis\resources\views/frontend/skinoasis/pages/users/dashboard.blade.php ENDPATH**/ ?>