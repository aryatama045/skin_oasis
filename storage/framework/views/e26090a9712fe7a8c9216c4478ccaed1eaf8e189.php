        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-8">
                <div class="section-title text-center text-sm-start">
                    <h2 class="mb-0"><?php echo e(localize('You may be interested')); ?></h2>
                </div>
            </div>
            <div class="col-sm-4">
...
<?php /**PATH C:\xampp\htdocs\skin_oasis\resources\views/frontend/skinoasis/pages/partials/products/related-products.blade.php ENDPATH**/ ?>