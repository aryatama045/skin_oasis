<aside class="tt-sidebar bg-light-subtle" id="sidebar">
    <div class="tt-brand">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="tt-brand-link">
            ...
            <img src="<?php echo e(uploadedAsset(getSetting('admin_panel_logo'))); ?>" class="tt-brand-favicon ms-1" style="max-width: 90%" alt="favicon" />
            <!-- <img src="<?php echo e(uploadedAsset(getSetting('system_title'))); ?>" class="tt-brand-logo ms-2" alt="logo" /> -->
            &nbsp;<!-- <h3 style="margin-top: 10px" class="tt-brand-logo ms-2"><?php echo e(getSetting('system_title')); ?></h3> -->
        </a>
...
<?php /**PATH C:\xampp\htdocs\skin_oasis\resources\views/backend/inc/leftSidebar.blade.php ENDPATH**/ ?>