<section class="gallery bg-white pt-10 pb-xs-15" >
    <div class="container mb-3">
        <div class="row">
            <div class="col-md-8">
                <div class="clearfix">
                    <div class="heading mt-3  wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                    ...
                    <div class="entry-content text-justify mt-lg-10 mb-6 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                        <p>
            ...
            <div class="col-md-4 p-md-0 wow animate__animated animate__fadeInLeft" data-wow-delay=".0s">
    ...
    <div class="video-banner video-banner-poster text-left mt-10  wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
        <div class="container">
