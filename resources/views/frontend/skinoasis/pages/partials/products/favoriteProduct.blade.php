    ...
    <div class="product bg-white shadow-none">
        ...
        <div class="product-body text-center">
            ...
            <div class="product-footer justify-content-center d-block">
                ...
                @endphp
                @if ($isVariantProduct)
                    <a href="javascript:void(0);" class="btn font-size-normal letter-spacing-large w-100"
                    ...
                    <form action="" class="direct-add-to-cart-form">
                        ...
                        @else
                            <a href="javascript:void(0);" onclick="directAddToCartFormSubmit(this)"
                                class="btn font-size-normal letter-spacing-large w-100 direct-add-to-cart-btn add-to-cart-text">
