    ...
    <div class="product shadow-none">
        ...
        <div class="product-body text-left bg-transparant">
            ...
            <div class="text-left d-block">
                ...
                @endphp
                @if ($isVariantProduct)
                    <a href="javascript:void(0);" class="font-size-large fw-bold text-danger text-uppercase letter-spacing-large w-100"
                    ...
                    <form action="" class="direct-add-to-cart-form">
                        ...
                        @else
                            <a href="javascript:void(0);" onclick="directAddToCartFormSubmit(this)"
                                class="font-size-large fw-bold text-danger text-uppercase letter-spacing-large w-100 direct-add-to-cart-btn add-to-cart-text">
