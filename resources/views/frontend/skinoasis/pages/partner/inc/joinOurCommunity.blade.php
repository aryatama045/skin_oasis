<form class="contact-form ps-4 ps-xl-0 py-8 pe-5 contact-form ps-5 ps-xl-4 py-6 pe-6"
    action="{{ route('Community.store') }}" method="POST" >
    @csrf

    {!! RecaptchaV3::field('recaptcha_token') !!}
    <div class="row g-4">

        <input type="hidden" name="type_join" value="community" required>
        ...
        <div class="col-sm-4">
            <div class="w-100 label-input-field">
                ...
                <select class="select2Comm" name="country_id3" required>
                    <option value="">{{ localize('Select Country') }}</option>
                    @foreach ($country3 as $country)
        ...
        <div class="col-sm-4">
            <div class="w-100 label-input-field">
                ...
                <select class="select2Comm" required name="state_id3">
        ...
        <div class="col-sm-4">
            <div class="w-100 label-input-field">
                ...
                <select class="select2Comm" required name="city_id3">
        ...
        <div class="col-sm-4">
            <div class="label-input-field">
                ...
                <input type="text" name="kodepos" placeholder="You Kode Pos"
                    required>
            </div>
        </div>
