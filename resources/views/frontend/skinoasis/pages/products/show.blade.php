                    ...
                    <div class="product-gallery product-gallery-vertical">
                        <div class="row">
                            <figure class="product-main-image">
                                <img id="product-zoom" src="{{ staticAsset('frontend/skinoasis/assets/images/products/single/1.jpg') }}" data-zoom-image="{{ staticAsset('frontend/skinoasis/assets/images/products/single/1-big.jpg') }}" alt="product image">
        ...
        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
            ...
            <div class="product product-7 text-center">
                <figure class="product-media">
                    ...
                    <a href="product.html">
                        <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-4.jpg') }}" alt="Product image" class="product-image">
                    </a>
                ...
                <div class="product-body">
                    ...
                    <div class="product-nav product-nav-thumbs">
                        <a href="#" class="active">
                            <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-4-thumb.jpg') }}" alt="product desc">
                        </a>
                        <a href="#">
                            <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-4-2-thumb.jpg') }}" alt="product desc">
                        </a>

                        <a href="#">
                            <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-4-3-thumb.jpg') }}" alt="product desc">
                        </a>
                    </div><!-- End .product-nav -->
            ...
            <div class="product product-7 text-center">
                <figure class="product-media">
                    ...
                    <a href="product.html">
                        <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-6.jpg') }}" alt="Product image" class="product-image">
                    </a>
            ...
            <div class="product product-7 text-center">
                <figure class="product-media">
                    ...
                    <a href="product.html">
                        <img src="{{ staticAsset('frontend/skinoasis/assets/images/products/product-11.jpg') }}" alt="Product image" class="product-image">
                    </a>
