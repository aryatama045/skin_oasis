<div class="banner-big" style="background-image: url({{ staticAsset('frontend/skinoasis/assets/images/h-b-banner.png') }}); background-color: #f1f5f7;">
    <div class="banner-content">
        <div class="banner-subtitle text-secondary">Cerita</div>
        <div class="banner-title text-secondary mb-3 ls-1px">#Halo Beauty</div>
        <p class="font-weight-normal mt-3 ls-1px">Perjuangan Hendra Melawan Jerawat Menahun.</p>
