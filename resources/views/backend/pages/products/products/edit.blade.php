                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="myTextarea" class="" name="description">{{ $product->collectLocalization('description', $lang_key) }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="additional_info" class="form-label">Informasi Tambahan (Cara Pakai, Komposisi atau Lainnya)</label>
                                    <textarea id="myTextarea2" class="" name="additional_info">{{ $product->additional_info }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="tt-select-brand">
                                                <select class="select2 form-control" id="is_popular"
                                                    name="is_popular">
                                                    <option value="1" {{ $product->is_popular == 1 ? 'selected' : '' }}>Enabled</option>
                                                    <option value="0" {{ $product->is_popular == 0 ? 'selected' : '' }}>Disabled</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
