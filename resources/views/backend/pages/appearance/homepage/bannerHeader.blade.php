                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Banner Header') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="banner_header_link"
                                        class="form-label">{{ localize('Banner Link ') }}</label>
                                    <input type="hidden" name="types[]" value="banner_header_link">
                                    <input type="url" name="banner_header_link"
                                        id="banner_header_link"
                                        placeholder="{{ env('APP_URL') . '/example' }}" class="form-control"
                                        value="{{ getSetting('banner_header_link') }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ localize('Banner Header Image') }}</label>
                                    ...
                                    <div class="tt-image-drop rounded">
                                        ...
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                ...
                                                <input type="hidden" name="banner_header"
                                                    value="{{ getSetting('banner_header') }}">
